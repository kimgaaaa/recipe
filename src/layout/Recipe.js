...
const Recipe = () => {
    ...
    const {RCP_NM,ATT_FILE_NO_MK,RCP_PARTS_DTLS,INFO_ENG,INFO_CAR,INFO_PRO,INFO_FAT,RCP_NA_TIP,INFO_NA} = recipe;
    ...
    return (
        <div className='detail'>
            <img src={ATT_FILE_NO_MK} alt={RCP_NM} className="detail_mainimg" />
